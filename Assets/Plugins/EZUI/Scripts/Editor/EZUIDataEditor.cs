...
namespace EZUIEditor
{
	...
	internal class EZUIDataEditor : Editor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			DrawPages(pages, data, out bool foundDuplicate);
		...
		private void DrawPages(List<EZUIData.Page> pages, EZUIData data, out bool foundDuplicate)
		{
			...
			for (int i = 0; i < pages.Count; i++)
			{
				...
				foundDuplicate = duplicateKeys.Count > 1;
		...
		private void EditPage(EZUIData.Page page, EZUIData data)
		{
			EditorGUILayout.BeginHorizontal();
			GUILayout.Space(40);
